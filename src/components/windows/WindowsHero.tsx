        ...
        <div className="pt-8 mb-8 grid lg:grid-cols-2 gap-10 md:gap-14 lg:gap-16 items-center">
          ...
          <div className="pt-8 text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
              Premium Windows for Light, Comfort & Modern Living
            </h1>

            <p className="text-lg md:text-xl text-neutral-600 mb-6 md:mb-8">
              Transform your spaces with high-quality window
              solutions designed for durability, ventilation,
              energy efficiency, and visual appeal.
            </p>

            <p className="text-neutral-600 mb-8 md:mb-10 max-w-2xl mx-auto lg:mx-0">
              From modern homes to commercial buildings,
              our window systems are engineered to deliver
